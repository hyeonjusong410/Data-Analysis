...
# X_border_smote, Y_border_smote = borderline_smote.fit_resample(X_train_pca, y_train)

# # ADASYN 적용
# from imblearn.over_sampling import ADASYN

# adasyn = ADASYN(random_state=42)
# X_adasyn, Y_adasyn = adasyn.fit_resample(X_train_pca, y_train)
...
y_pred_proba = rf_model.predict_proba(X_test_pca)[:, 1]
